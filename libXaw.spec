...
Version  : 1.0.15
Release  : 13
URL      : https://www.x.org/releases/individual/lib/libXaw-1.0.15.tar.xz
Source0  : https://www.x.org/releases/individual/lib/libXaw-1.0.15.tar.xz
Source1  : https://www.x.org/releases/individual/lib/libXaw-1.0.15.tar.xz.sig
...
%prep
%setup -q -n libXaw-1.0.15
cd %{_builddir}/libXaw-1.0.15
pushd ..
cp -a libXaw-1.0.15 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702027368
