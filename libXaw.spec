...
Source0  : https://www.x.org/releases/individual/lib/libXaw-1.0.16.tar.xz
Source1  : https://www.x.org/releases/individual/lib/libXaw-1.0.16.tar.xz.sig
...
%prep
%setup -q -n libXaw-1.0.16
cd %{_builddir}/libXaw-1.0.16
pushd ..
cp -a libXaw-1.0.16 build32
popd
pushd ..
cp -a libXaw-1.0.16 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710170529
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libXaw6.so.6.0.1
/V3/usr/lib64/libXaw7.so.7.0.0
